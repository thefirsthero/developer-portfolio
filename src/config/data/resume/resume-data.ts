...
export const resumeData = {
  ...
  skills: [
    { name: "C# & LINQ", level: 90, icon: "Code", color: "#6A0DAD" },
    { name: ".NET 6/8 & ASP.NET Core", level: 85, icon: "Server", color: "#512BD4" },
    { name: "Entity Framework Core", level: 80, icon: "Database", color: "#336699" },
    { name: "SQL Server & T-SQL", level: 80, icon: "Database", color: "#CC2927" },
    { name: "Microsoft Azure", level: 75, icon: "Cloud", color: "#0078D4" },
    { name: "Azure DevOps & CI/CD", level: 80, icon: "GitFork", color: "#0078D4" },
    { name: "Vue.js", level: 70, icon: "Sparkles", color: "#4FC08D" },
    { name: "React", level: 65, icon: "Atom", color: "#61DAFB" },
    { name: "JavaScript", level: 70, icon: "Code", color: "#F7DF1E" },
    { name: "Python", level: 60, icon: "Worm", color: "#3776AB" },
    { name: "Flutter", level: 55, icon: "Smartphone", color: "#02569B" },
    { name: "Docker", level: 70, icon: "Container", color: "#2496ED" },
    { name: "Git & GitHub", level: 85, icon: "GitFork", color: "#F05032" },
  ],
